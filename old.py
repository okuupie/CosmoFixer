...
def warning():
    show_fulltext('ВНИМАНИЕ!!! ИСПРАВЛЕНИЕ УДАЛЯЕТ КОНФИГИ!!!', 3)
...
def cleantemp():
    try:
        ...
        window.debug.write("НУЖНЫ ПРАВА АДМИНИСТРАТОРА!!!")
...
window = sgui(
    ...
    l2 = bigbutton('исправить котлаван'),
